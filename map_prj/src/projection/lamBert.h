...
#define LAMBERT_OUTPUT_ERROR       0x2000
 ...
 *       LAMBERT_B_ERROR            : Semi-minor axis less than or equal to zero
 *       LAMBERT_A_LESS_B_ERROR     : Semi-major axis less than semi-minor axis
...
extern "C" {
#endif
/* 经纬度－大地坐标转换，经纬度单位为弧度，大地坐标为米*/
extern unsigned int Set_Lambert_Parameters(double a,
	double b,
...
extern void Get_Lambert_Parameters(double *a,
	double *b,
	double *Origin_Latitude,
	double *Central_Meridian,
	double *Std_Parallel_1,
...
extern unsigned int Convert_Geodetic_To_Lambert (double Latitude,
	double Longitude,
	double *Easting,
	double *Northing);
...
extern unsigned int Convert_Lambert_To_Geodetic (double Easting,
	double Northing,
	double *Latitude,
	double *Longitude);
